...
describe('RegisterPage.vue', () => {
  ...
  it('should have form inputs bound with data model', async () => {
    ...
    await wrapper.vm.$nextTick() // Vue performs DOM updates asynchronously.
  ...
  it('should fail it is not a new user', async () => {
    ...
    wrapper.vm.submitForm()
    expect(registerSpy).toBeCalled()
    await wrapper.vm.$nextTick() // 1st await: wait axios Promise to complete
    await wrapper.vm.$nextTick() // 2nd await: wait for Vue DOM to update
